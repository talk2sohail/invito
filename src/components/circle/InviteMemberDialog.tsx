    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md bg-zinc-950/90 border-white/10 text-white backdrop-blur-xl shadow-2xl">
          ...
          <div className="relative">
            ...
            <Button
                ...
                className={cn(
                    ...
                    isCopied ? "bg-green-500/20 text-green-500 hover:bg-green-500/30" : "bg-white/10 text-white hover:bg-white/20"
                )}
            >
                {isCopied ? (
                <>
        ...
        <DialogFooter className="sm:justify-between mt-4 items-center">
          ...
          <DialogClose asChild>
            <Button type="button" variant="secondary" className="bg-white/10 hover:bg-white/20 text-white border-0">
              Done
            </Button>
          </DialogClose>
        </DialogFooter>
