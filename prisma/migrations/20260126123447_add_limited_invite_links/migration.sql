...
-- AddForeignKey
ALTER TABLE "CircleInviteLink" ADD CONSTRAINT "CircleInviteLink_creatorId_fkey" FOREIGN KEY ("creatorId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
